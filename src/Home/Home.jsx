            ...
            <header className="container">
                <div className="h-16 flex items-center justify-between">
                    ...
                    <div className="gap-5 flex justify-end w-1/2 relative">
                        ...
                        <div className={`absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-[rgb(33,33,33)] text-[#f3f4f5] py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none transform opacity-100 ${scale} top-12 duration-300`}>
