...
const Error = () => {
    return (
        <section className="grid h-screen pt-32 pb-16 font-rem bg-orange1 rounded-b-xl lg:rounded-none">
            <div className="container grid content-center gap-12 lg:max-w-5xl lg:grid-cols-2 lg:items-center">
                ...
                <div className="justify-self-center">
                    <img
                        src="https://classroomcoins.uz/static/media/ghost.cbedbdd72a5c40e33a18.png"
